let isArray, has;
let Position, SourceLocation, getLineInfo;
let lineBreak, lineBreakG, isNewLine, nonASCIIwhitespace, skipWhiteSpace;
let reservedWords, keywords, isIdentifierStart, isIdentifierChar;
let tokTypes, TokenType;
...
exports = {
    isArray: isArray, has: has,
    Position: Position, SourceLocation:  SourceLocation, getLineInfo:  getLineInfo,
    lineBreak: lineBreak, lineBreakG:  lineBreakG, isNewLine:  isNewLine, nonASCIIwhitespace:  nonASCIIwhitespace, skipWhiteSpace:  skipWhiteSpace,
    reservedWords: reservedWords, keywords:  keywords, isIdentifierStart:  isIdentifierStart, isIdentifierChar:  isIdentifierChar,
    tokTypes: tokTypes, TokenType:  TokenType,
    defaultOptions: defaultOptions, getOptions:  getOptions,
    Parser: Parser,
}